...
def review_code_prompt(task_spec: "TaskSpec", code: str) -> str:
    ...
    class_checks = (
        "  6. A required public method from the spec is missing\n"
        "  7. State is stored incoherently (e.g. items dict inconsistency)\n"
        "  8. print() is used instead of raise for validation failures\n"
